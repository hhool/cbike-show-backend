...
export const metadata = { title: "产品中心 | 曲周童车产业带" };

const categoryList = [
  { key: "", label: "全部产品" },
  { key: "bike", label: "儿童自行车" },
  { key: "balance", label: "平衡车" },
  { key: "scooter", label: "滑板车" },
  { key: "toy", label: "玩具车" },
  { key: "stroller", label: "婴儿车/推车" },
  { key: "electric", label: "电动车" },
];
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900">产品中心</h1>
          <p className="text-gray-500 mt-1">曲周产业带 {products.length}+ 款优质童车产品</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 flex flex-col lg:flex-row gap-6">
        ...
        <aside className="w-full lg:w-52 shrink-0 space-y-4">
          <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">产品分类</div>
        ...
        <div className="flex-1">
          <div className="mb-4">
            <p className="text-sm text-gray-500">共 <span className="font-semibold text-gray-800">{products.length}</span> 件产品</p>
          </div>
