...
const CATEGORY_SEEDS: CategorySeed[] = [
  ...
  },
  {
    ...
    nameZh: "新品首发",
    nameEn: "New Arrival",
    descriptionZh: "新品上手与首发测评。",
    descriptionEn: "First-look and launch reviews for new arrivals.",
    sortOrder: 20,
    isSystem: true,
    isVisibleInTabs: true,
  },
  ...
  },
  {
    ...
    nameZh: "多品横评",
    nameEn: "Comparison",
    descriptionZh: "同价位或同场景多产品对比测评。",
    descriptionEn: "Comparison across multiple products in the same budget or scenario.",
    sortOrder: 40,
    isSystem: true,
    isVisibleInTabs: true,
  },
  ...
  },
  {
    key: "cross_border",
    nameZh: "跨境转型",
    nameEn: "Cross-border Transformation",
    descriptionZh: "面向跨境市场的合规与使用测评。",
